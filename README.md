...
<video src="docs/images/ai-trade-flow-brag.mp4" controls width="100%" title="AI Trade Flow launch video"></video>

[觀看 launch video / Watch the launch video](docs/images/ai-trade-flow-brag.mp4)
...
- The dashboard screenshot above is a self-contained SVG generated by
  [`docs/images/_generate.py`](./docs/images/_generate.py). The README launch video is stored at
  [`docs/images/ai-trade-flow-brag.mp4`](./docs/images/ai-trade-flow-brag.mp4).
